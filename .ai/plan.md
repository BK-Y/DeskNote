...
- Phase 7 负责决定“何时把 working text 推进到 persisted baseline”
- Phase 8 负责决定“推进 persisted baseline 时如何可靠写盘”
- Phase 9 负责决定“working text 尚未进入 persisted baseline 时，如何提供恢复层”
