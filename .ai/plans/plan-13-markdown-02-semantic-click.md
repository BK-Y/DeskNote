# phase-12-markdown-semantic-click — 语义点击行为
...
| 编号 | 用例 | 操作 | 预期 |
|------|------|------|------|
| 12-3 | 点击链接 | Markdown 有 `[link](https://example.com)`，点击 "link" | 浏览器打开 `https://example.com` |
| 12-4 | 点击勾选框 | `- [ ] task` → 点击 `[ ]` | 文档变为 `- [x] task` |
| 12-5 | 再次点击勾选框 | `- [x] task` → 点击 `[x]` | 文档变为 `- [ ] task` |

### 边界条件
| 编号 | 用例 | 操作 | 预期 |
|------|------|------|------|
| 12-6 | 点击无 URL 链接 | `[broken]()` 或 URL 为空 | 不打开，不崩溃 |
| 12-7 | 编辑区内链接 | 光标在链接文本中，按住 Ctrl 点击 | 打开链接，不移动光标 |

### 回归
| 编号 | 用例 | 操作 | 预期 |
|------|------|------|------|
| 12-8 | 纯文本编辑不受影响 | 正常编辑 | 不受影响 |
| 12-9 | 编译通过 | `cmake --build build` | 零错误 |

### 集成
| 编号 | 用例 | 操作 | 预期 |
|------|------|------|------|
| 12-10 | Alt 键不影响点击 | 按住 Alt 点击链接 | 正常处理 |
