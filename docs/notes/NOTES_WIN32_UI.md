# DeskNote 学习笔记 - Win32 UI 开发

> 窗口样式、C vs C++、多文件编译、鼠标跟踪、资源文件、窗口定位、TRACKMOUSEEVENT、消息大全、WM_PAINT、自动隐藏
...
- [7. 窗口样式速查](#7-窗口样式速查)
  - [7.1 常用窗口样式 (WS_)](#71-常用窗口样式-ws_)
  - [7.2 组合宏拆解](#72-组合宏拆解)
  - [7.3 窗口类样式 (CS_)](#73-窗口类样式-cs_)
  - [7.4 扩展窗口样式 (WS_EX_)](#74-扩展窗口样式-ws_ex_)
  - [7.5 窗口样式和类的区别](#75-窗口样式和类的区别)
- [8. C vs C++ 编译对比](#8-c-vs-c-编译对比)
  - [8.1 为什么可以改为 C 编译](#81-为什么可以改为-c-编译)
  - [8.2 C 编译比 C++ 省了什么](#82-c-编译比-c-省了什么)
  - [8.3 文件后缀 .c vs .cpp](#83-文件后缀-c-vs-cpp)
- [9. 多文件编译与模块拆分](#9-多文件编译与模块拆分)
  - [9.1 为什么拆文件](#91-为什么拆文件)
  - [9.2 标题栏拆分示例](#92-标题栏拆分示例)
  - [9.3 头文件 (.h) 的作用](#93-头文件-h-的作用)
  - [9.4 include 的双引号与尖括号](#94-include-的双引号与尖括号)
  - [9.5 CMakeLists.txt 添加新源文件](#95-cmakeliststxt-添加新源文件)
  - [9.6 这次拆分的收获](#96-这次拆分的收获)
- [10. 鼠标跟踪机制](#10-鼠标跟踪机制)
  - [10.1 系统自动触发 vs 程序手动注册](#101-系统自动触发-vs-程序手动注册)
  - [10.2 为什么系统不自动发 WM_MOUSELEAVE](#102-为什么系统不自动发-wm_mouseleave)
  - [10.3 TrackMouseEvent 的使用模式](#103-trackmouseevent-的使用模式)
  - [10.4 悬停效果的完整流程](#104-悬停效果的完整流程)
  - [10.5 关键点总结](#105-关键点总结)
- [11. 资源文件与图标](#11-资源文件与图标)
  - [11.1 什么是 .rc 文件](#111-什么是-rc-文件)
  - [11.2 资源编译流程](#112-资源编译流程)
  - [11.3 .rc 文件语法](#113-rc-文件语法)
  - [11.4 在代码中加载图标](#114-在代码中加载图标)
  - [11.5 不写 .rc 的后果](#115-不写-rc-的后果)
  - [11.6 其他资源文件的 CMake 配置](#116-其他资源文件的-cmake-配置)
- [12. 窗口尺寸与定位](#12-窗口尺寸与定位)
  - [12.1 获取屏幕尺寸](#121-获取屏幕尺寸)
  - [12.2 定位到屏幕右上角](#122-定位到屏幕右上角)
  - [12.3 窗口尺寸的选择](#123-窗口尺寸的选择)
  - [12.4 标准便签风格 vs 普通窗口](#124-标准便签风格-vs-普通窗口)
- [13. TRACKMOUSEEVENT 详解](#13-trackmouseevent-详解)
  - [13.1 结构体定义](#131-结构体定义)
  - [13.2 dwFlags 取值](#132-dwflags-取值)
  - [13.3 一次性机制](#133-一次性机制)
  - [13.4 为什么设计为一次性](#134-为什么设计为一次性)
  - [13.5 vs WM_NCHITTEST](#135-vs-wm_nchittest)
- [14. Win32 预定义消息大全](#14-win32-预定义消息大全)
  - [14.1 窗口生命周期](#141-窗口生命周期)
  - [14.2 鼠标消息](#142-鼠标消息)
  - [14.3 键盘消息](#143-键盘消息)
  - [14.4 绘制与窗口变化](#144-绘制与窗口变化)
  - [14.5 非客户区消息](#145-非客户区消息)
  - [14.6 WM_NCHITTEST 返回值大全](#146-wm_nchittest-返回值大全)
  - [14.7 焦点与激活](#147-焦点与激活)
  - [14.8 定时器](#148-定时器)
  - [14.9 剪贴板](#149-剪贴板)
  - [14.10 消息分组速记](#1410-消息分组速记)
  - [14.11 一个最简 WndProc 需要处理哪些](#1411-一个最简-wndproc-需要处理哪些)
- [15. WM_PAINT 触发链与绘制流程](#15-wm_paint-触发链与绘制流程)
  - [15.1 核心机制](#151-核心机制)
  - [15.2 InvalidateRect 的含义](#152-invalidaterect-的含义)
  - [15.3 标题栏的绘制触发链](#153-标题栏的绘制触发链)
  - [15.4 WM_PAINT 的标准写法](#154-wm_paint-的标准写法)
  - [15.5 绘制不是"定时执行"的](#155-绘制不是定时执行的)
- [16. 自动靠边隐藏机制](#16-自动靠边隐藏机制)
  - [16.1 触发链](#161-触发链)
  - [16.2 弹出链](#162-弹出链)
  - [16.3 两个触发条件的区别](#163-两个触发条件的区别)
  - [16.4 隐藏状态管理](#164-隐藏状态管理)
  - [16.5 三个入口](#165-三个入口)
  - [16.6 相关系统 API](#166-相关系统-api)
